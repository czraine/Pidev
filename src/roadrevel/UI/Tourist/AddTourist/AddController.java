package roadrevel.UI.Tourist.AddTourist;
...
import roadrevel.entities.Tourist.ServiceTourist;
import roadrevel.entities.Tourist.Tourist;
...
public class AddController implements Initializable {
    ...
    private void handleAddOperation(ActionEvent event) {
        ...
        if (natio.isEmpty()) {
            AlertMaker.showMaterialDialog(rootPane, mainContainer, new ArrayList<>(), "Insufficient Data", "Please enter Nationality.");
            return;
        }
        if (langue.isEmpty()) {
            AlertMaker.showMaterialDialog(rootPane, mainContainer, new ArrayList<>(), "Insufficient Data", "Please re-enter Langue.");
            return;
        }
        ...
        Tourist pv = new Tourist(Fname, lname,  email,uname, Pass, tpho, Role, natio, langue);
