...
public class View_SingleController implements Initializable {
    ...
    public void infalteUI(Events selected) {
        ...
        EventHandler<ActionEvent> Grate = new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e) {
                ...
                Util.loadWindow(getClass().getResource("/roadrevel/UI/AddReview/AddEventReview.fxml"), "Add New comment", null);
    ...
    private void loadcommentPage(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/roadrevel/UI/AddReview/AddEventReview.fxml"));
    ...
    private void ReviewListLoader(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/roadrevel/UI/viewReviewList/ReviewList.fxml"));
        Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        Scene scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
