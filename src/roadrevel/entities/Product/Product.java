...
public class Product {
    ...
    public Product(int id_Produit, String Name_prod, String prodDescrp, String Type_prod, Double Product_Price, Double Qte, String Product_img, String status) {
        this.id_Produit = id_Produit;
    ...
    public Product(String Name_prod, String prodDescrp, String Type_prod, Double Product_Price, Double Qte, String Product_img, String status) {
        this.Name_prod = Name_prod;
        this.prodDescrp = prodDescrp;
        this.Type_prod = Type_prod;
        this.Product_Price = Product_Price;
    ...
    public String toString() {
        return "Product{" + "id_Product=" + id_Produit + ", Name_prod=" + Name_prod + ", Type_prod=" + Type_prod + ", Product_Price=" + Product_Price + ", Qte=" + Qte + ", Product_img=" + Product_img + ", status=" + status + '}';
    }
